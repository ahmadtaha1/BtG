...
if(control_case==1)
    ...
    load('case_9_sys_b');
    load('case_9_sys_g');
    load('case_9_sc_2_hvac');
    load('case_9_sc_2_zonetemp');
    pcnt_sp=0.3;
elseif(control_case==2)
    ...
    load('case_14_sys_b');
    load('case_14_sys_g');
    load('case_14_sc_2_hvac');
    load('case_14_sc_2_zonetemp');
    pcnt_sp=0.5;
elseif(control_case==3)
    ...
    load('case_30_sys_b');
    load('case_30_sys_g');
    load('case_30_sc_2_hvac');
    load('case_30_sc_2_zonetemp');
    pcnt_sp=0.5;
elseif(control_case==4)
    ...
    load('case_57_sys_b');
    load('case_57_sys_g');
    load('case_57_sc_2_hvac');
    load('case_57_sc_2_zonetemp');
    pcnt_sp=0.5;
end
...
% This one is for decoupled MPC problem, Scenario 2
...
for t=T_start:hg:T_final 
    if (mod(t,T_p)==1)         % Check condition for start of the prediction horizon (of time_predict seconds)
        ...
        limit_n.ug_vars_high=pcnt_sp*limit_n.ug_sps_high;
        limit_n.ug_vars_low=-pcnt_sp*limit_n.ug_sps_high;

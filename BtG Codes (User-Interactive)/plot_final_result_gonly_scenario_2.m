function plot_final_result_gonly_scenario_2(time,N,Ng,Nb,hg,hb,T_p,z,g_s,b_s,base,zone_temp)
% Author: Ankur Pipri
...
% Zone Temperatures
subplot(2,1,1)
max_zt=max(zone_temp);
min_zt=min(zone_temp);

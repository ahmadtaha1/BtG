% function [ H,F,ANEQ,BNEQ,AEQ,BEQ,LB,UB ] = Problem_1(N,Ng,...
%     Nb,Nl,z,base,xb0,xg0,g_s,b_s,count_tg,count_tb,count_tp,avg_load)
function Problem_3(N,Nb,Ng,Nc,b_s,g_s,base,z,count_tg,count_tb,xb0,xg0,opt_ub,opt_usp)
% Author: Ankur Pipri

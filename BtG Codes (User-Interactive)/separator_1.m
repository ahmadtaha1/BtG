function separator_1(X,N,Nb,Ng,g_s,b_s,count_tg,count_tb,count_tp)
% Author: Ankur Pipri
...
XGS=X((2*Nb*b_s)+(Nb*b_s)+1:(2*Nb*b_s)+(Nb*b_s)+...
    (2*N*g_s));                                  % Extraction of Grid States
XUMP=X((2*Nb*b_s)+(Nb*b_s)+(2*N*g_s)+1:end);   % Extraction of Mechanical Power Variations
